...
class MockApplicationsRepository implements ApplicationsRepository {
  ...
  Future<Application?> getApplication(String applicationId) async {
    return _applications.where((a) => a.id == applicationId).firstOrNull;
  }

  @override
  Future<List<Job>> getJobs(String organizationId) async {
    return _mockJobs.where((j) => j.organizationId == organizationId).toList();
  }
      ...
      PageSection(
        ...
        items: [
          ...
          },
          {
            ...
            'answer': 'ローテーション制で月1〜2回程度です。手当を別途支給しています。',
          },
        ],
      ),
    ],
