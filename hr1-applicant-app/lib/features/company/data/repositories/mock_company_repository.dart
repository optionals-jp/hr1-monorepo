      ...
      PageTab(
        ...
        sections: [
          PageSection(
            ...
            title: '',
            order: 1,
            content: '現在募集中のポジションです。カジュアル面談も随時受け付けています。',
          ),
          PageSection(
            id: 's4',
...
''',
          ...
          PageSection(
            ...
            items: [
              {
                'title': 'エンジニアドリブン',
                'description': '技術選定はエンジニア主導。新しい技術のPoC期間を四半期ごとに確保しています。',
              },
              {
                'title': 'OSSへの貢献',
                'description': '業務時間の10%をOSS活動に充てることができます。社内ライブラリの公開も積極的に推進。',
              },
              {
                'title': '心理的安全性',
                'description': 'ポストモーテム文化を大切にし、失敗を責めるのではなく学びに変えるチーム運営を実践しています。',
              },
              {
                'title': 'ハッカソン',
                'description': '四半期に1度、2日間のハッカソンを開催。プロダクトに採用されたアイデアも多数あります。',
              },
            ],
          ),
          PageSection(
          ...
          PageSection(
            ...
            items: [
              ...
              },
              {
                ...
                'answer': 'フルリモート勤務が可能です。月1回のオフサイトミーティングがありますが、参加は任意です。',
              },
              {
