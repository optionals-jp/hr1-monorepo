...
export default function CertificationsSettingsPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <StickyFilterBar>
        <SearchBar value={h.search} onChange={h.setSearch} placeholder="資格名・カテゴリで検索" />
        <DropdownMenu>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              自社専用の資格を追加します。共通資格は全企業で共有されています。
            </DialogDescription>
          </DialogHeader>
